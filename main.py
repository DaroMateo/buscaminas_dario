...
SONIDO_CELDA_DESCUBIERTA = pygame.mixer.Sound("buscaminas/archivos_extras/coin_mario-[AudioTrimmer.com].mp3")
SONIDO_FIN_JUEGO = pygame.mixer.Sound("buscaminas/archivos_extras/game_over.mp3")
SONIDO_VICTORIA = pygame.mixer.Sound("buscaminas/archivos_extras/goodresult-82807.mp3")
